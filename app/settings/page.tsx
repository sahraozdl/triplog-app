      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your role and identification within the company.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleAddressChange("homeAddress", "country", e.target.value)
                }
              />
            </div>
          </CardContent>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleAddressChange("workAddress", "country", e.target.value)
                }
              />
            </div>
          </CardContent>
