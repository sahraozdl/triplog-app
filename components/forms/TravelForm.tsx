            ...
            <div className="w-full flex flex-col justify-between gap-12">
              <div className="w-full flex flex-row justify-between gap-12">
                <div className="flex flex-col w-1/2 gap-1">
                  <Label
                    htmlFor="travel-reason"
                  >
                    Travel Reason
                  </Label>
                  <Input type="text" id="travel-reason" placeholder="e.g. Business" />
                </div>
                <div className="flex flex-col w-1/2 gap-1 ">
                <Label
                ...
                <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="company-car-electric_gas">Company Car (Electric/Gas)</SelectItem>
                      <SelectItem value="company-car-petrol_diesel">Company Car (Petrol/Diesel)</SelectItem>
              ...
              <div className="flex flex-row gap-12">
                <div className="flex flex-col w-1/2 gap-1">
                  ...
                  <Input type="number" id="distance" placeholder="e.g. 100" min={0} />
                </div>
                <div className="flex flex-col w-1/2 gap-1">
